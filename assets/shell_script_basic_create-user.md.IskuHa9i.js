import{_ as a,c as e,o as n,ag as p}from"./chunks/framework.BZemHgQ6.js";const h=JSON.parse('{"title":"Basic Shell Script to Create User","description":"","frontmatter":{},"headers":[],"relativePath":"shell_script/basic/create-user.md","filePath":"shell_script/basic/create-user.md"}'),t={name:"shell_script/basic/create-user.md"};function i(l,s,c,r,o,u){return n(),e("div",null,s[0]||(s[0]=[p(`<h1 id="basic-shell-script-to-create-user" tabindex="-1">Basic Shell Script to Create User <a class="header-anchor" href="#basic-shell-script-to-create-user" aria-label="Permalink to &quot;Basic Shell Script to Create User&quot;">​</a></h1><h2 id="requirement" tabindex="-1">Requirement <a class="header-anchor" href="#requirement" aria-label="Permalink to &quot;Requirement&quot;">​</a></h2><ul><li>Linux</li></ul><h2 id="step" tabindex="-1">Step <a class="header-anchor" href="#step" aria-label="Permalink to &quot;Step&quot;">​</a></h2><ol><li>Create script with your desired name, example <code>create-user.sh</code>, then copy content below</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#!/bin/bash</span></span>
