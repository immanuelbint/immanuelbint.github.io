...
<span class="line"><span>fi</span></span></code></pre></div><ol start="2"><li>Set the script executable with command</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>chmod +x &lt;namescript.sh&gt;</span></span></code></pre></div><ol start="3"><li>Then running the script without &lt;&gt;</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>bash &lt;namescript.sh&gt;</span></span></code></pre></div>`,10)]))}const q=a(p,[["render",i]]);export{d as __pageData,q as default};
