...
<span class="line"><span>echo $hostname    # Example output: l2-hostmaster-0.labs247.id</span></span></code></pre></div><p>Reset the CA database:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>rm -f index.txt serial.txt</span></span>
...
<span class="line"><span>                DNS:l2-hostmaster-0.labs247.id, DNS:l2-hostmaster-0.labs247.id, IP Address:172.30.2.4</span></span></code></pre></div><h3 id="update-nginx-configuration" tabindex="-1">Update Nginx Configuration <a class="header-anchor" href="#update-nginx-configuration" aria-label="Permalink to &quot;Update Nginx Configuration&quot;">​</a></h3><p>Modify the Nginx configuration to use the SSL certificate. Replace the paths below with your actual certificate locations (e.g., <code>/data/self-managed-ca</code>):</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sudo tee /etc/nginx/nginx.conf &lt;&lt;EOF</span></span>
